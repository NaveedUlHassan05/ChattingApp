...
open class PaperOnboarding: UIView {
    ...
    fileprivate var pageViewSelectedRadius: CGFloat = 5
    fileprivate var pageViewRadius: CGFloat = 5
    ...
    public init(pageViewBottomConstant: CGFloat = 0) {
    ...
    public required init?(coder aDecoder: NSCoder) {
        ...
        self.pageViewBottomConstant = 0
        self.pageViewSelectedRadius = 5
        self.pageViewRadius = 5
